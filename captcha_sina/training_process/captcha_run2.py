...
dataset = CaptchaDataset(characters, 1, width, height, n_input_length, n_len,TRAIN_DATASET_PATH)
...
batch_size = 128
# trans_set的length调一下
train_set = CaptchaDataset(characters = characters,length=1*batch_size, width=width, height=height, input_length=n_input_length, label_length=n_len,folder=TRAIN_DATASET_PATH)
...
torch.save(model.state_dict(), 'ctc_625_3.pth')
